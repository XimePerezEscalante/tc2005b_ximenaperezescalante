...
<body class="bg-rosa">
    <div class="container py-4 px-3 mx-auto">
        ...
        <nav class="navbar navbar-expand-lg rounded bg-rosa-medio">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" role="search">
                        <input class="form-control me-2 bg-rosa-medio text-light" type="search" placeholder="Search" aria-label="Search">
                        <button class="btn btn-outline-light" type="submit">Search</button>
                    </form>
                </div>
            </div>
        </nav>
        <h1 class="text-light text-center">Nuestros Favoritos</h1>
...
const server = http.createServer( (request, response) => {    
    if(request.method == "GET" && (request.url == "/xp3" || request.url == "/")) {
